...
from  myapp.views import Home, UserView, PBCView, PUIView, AddUserView, EditUserView, DeleteUserView, AddPBCView, EditPBCView, DeletePBCView, AddPUIView, EditPUIView, DeletePUIView
